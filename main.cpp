...
void inst(){
    ...
    cout<<endl<<"# Your password must be 5-20 characters long."<<endl;
...
string getCurrentDir() {
    ...
    string::size_type position = str.find_last_of("\\/");
...
string checkpassname(string user,string pass){
    string cusername, cpassword, cfilePath, cfileName;
    ...
    readdata.close();
    cout<<"No matching username and password\n";
    return "";
}
